import datetime, requests, os.path as op, time
import ConfigParser

def query_for_cyberfacts(app_id, app_key, start_datetime, end_datetime):
    url = 'https://www.surfwatchlabs.com/api/v3/feedRiskScores'
    headers = {'app-id': app_id, 'app-key': app_key, 'accept': 'text/csv', 'x-delimited-print-header': 'false'}
...
def backfill(app_id, app_key):
    ...
    # final_date = datetime.datetime(2016, 1, 18)
